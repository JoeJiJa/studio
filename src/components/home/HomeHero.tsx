...
export function HomeHero() {
  ...
  return (
    <div className="relative h-[50vh] md:h-[60vh] w-full flex items-center justify-center -mx-4 sm:-mx-6 lg:-mx-8">
      ...
      <div className="relative z-10 text-center container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl">
        <h1 className="text-4xl md:text-6xl font-bold font-headline text-white drop-shadow-lg">
          Welcome Back, Doctor!
        </h1>
        <p className="mt-4 text-lg text-primary-foreground/90 drop-shadow-md max-w-2xl mx-auto">
